        ...
        for cand_info in all_notified_candidates:
            try:
                ...
                notification = {
                    ...
                    'title': f"Tuyển gấp ở ngay gần bạn - Ứng tuyển ngay",
                    'titleEn': f"Urgent hiring near you - Apply now",
                    'message': f"{company} đang tuyển nhân viên làm gấp ngay trong khu vực của bạn. Xem chi tiết và ứng tuyển ngay!",
                    'messageEn': f"{company} is urgently hiring in your area. View details and apply now!",
